...
export function AuthForm() {
  ...
  return (
    <div className="w-full max-x-md bg-slate-900 border border-slate-800 rounded-xl p-6">
      <h1 className="text-xl font-semibold mb-4">TaskBoard</h1>

      <div className="flex gap-2 mb-4">
        <button
          className={`px-3 py-2 rounded-lg textsm border ${
        ...
        <button
          className={`px-3 py-2 rounded-lg text-sm border ${
            mode === "signup" ? "bg-slate-800 border-slat-700" : "border-slate-800"
          }`}
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <button
          className="w-full px-4 py-2 rouded-lg bg-indigo-500 disabled:opacity-60"
